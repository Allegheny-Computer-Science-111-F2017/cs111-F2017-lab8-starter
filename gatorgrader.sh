...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight/ \
                                     --checkfiles CommandLineCalculator.java --singlecomments 10 --multicomments 2 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "new Date()" fragment exists in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight \
                                     --checkfiles CommandLineCalculator.java --fragments "new Date()" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: the "while (" fragment does not exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight \
                                     --checkfiles CommandLineCalculator.java --fragments "while (" --fragmentcounts 0
  determine_exit_code $?
  # --> GatorGrader CHECK: the "if (" fragment does not exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight \
                                     --checkfiles CommandLineCalculator.java --fragments "if (" --fragmentcounts 0
  determine_exit_code $?
  # --> GatorGrader CHECK: the "Iterator" fragment does not exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight \
                                     --checkfiles CommandLineCalculator.java --fragments "Iterator" --fragmentcounts 0
  determine_exit_code $?
  # --> GatorGrader CHECK: the correct number of comments in the Java code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight/ \
                                     --checkfiles NumericalCalculator.java --multicomments 6 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "MAX_VALUE" fragment exists in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight \
                                     --checkfiles NumericalCalculator.java --fragments "MAX_VALUE" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: the "MIN_VALUE" fragment exists in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight \
                                     --checkfiles NumericalCalculator.java --fragments "MIN_VALUE" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: the "while (" fragment exists in the code at least set times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight \
                                     --checkfiles NumericalCalculator.java --fragments "while (" --fragmentcounts 4
  determine_exit_code $?
  # --> GatorGrader CHECK: the "Iterator" fragment exists in the code at least set times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight \
                                     --checkfiles NumericalCalculator.java --fragments "Iterator" --fragmentcounts 4
  determine_exit_code $?
  # --> GatorGrader CHECK: the "if (" fragment exists in the code at least set times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight \
                                     --checkfiles NumericalCalculator.java --fragments "if (" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: the "new Date()" fragment does not exist in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight \
                                     --checkfiles NumericalCalculator.java --fragments "new Date()" --fragmentcounts 0
  determine_exit_code $?
  # --> GatorGrader CHECK: there are no "println()" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labeight \
                                     --checkfiles NumericalCalculator.java --fragments "println(" --fragmentcounts 0
  determine_exit_code $?
